 ...
 <main    style={{
  ...
  backgroundPosition: 'center',
   ...
   <div className=" col-span-1"></div>
      ...
      }  ${name=="Maui" ? "w-3/4" : " w-1/2"}        ${name=="Pua" ? "w-3/4" : " w-1/2"}`}
...
/> */}
    ...
    <div className={`col-span-4 flex flex-col gap-4 mx-auto p-6 transform transition-all duration-700 ease-in-out  scale-110  space-y-6 `}>
