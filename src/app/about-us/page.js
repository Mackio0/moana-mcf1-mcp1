...
import {
  ...
  quote,
  StarWars,
} from "../../../public/images/moana_about";
    ...
    <>
      <main>
        ...
        <Container className=" grid grid-cols-12 gap-x-5 gap-y-10 items-start">
          ...
          <div className=" col-span-full ">
            <SliderComponent bottomControls={false} leftRightControls={true}>
              ...
              <div className=" col-span-4 p-5 relative border border-gray-500 bg-[#f5f5f5] rounded flex flex-col gap-5">
                <div className=" w-full -mt-24 ">
                  <Image
                    src={character1}
                    alt="user1"
                    className=" border-2 border-primary-700 rounded-full mx-auto"
                    width={150}
                    height={150}
                  />
                </div>
                <div className=" mt-5 ">
                  ...
                  <div className="space-y-2">
                    <GradientText
                      className=" text-center  font-leckerli "
                      heading="3"
                    >
                      Victoria Luxford
                    </GradientText>
                    <p>
                      Great fun. A traditional Disney Princess film but with a
                      little more depth to it, being about personal discovery
                      and bravery.
                    </p>
                  </div>
                  <div className=" inline-block w-full ">
